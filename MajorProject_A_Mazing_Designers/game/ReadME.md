...
3. Chess AI Engine:
   - Minimax Algorithm: The Dragon AI uses a recursive search algorithm with Alpha-Beta pruning to calculate moves in the least amount of time required.
...
4. Exploration: Enter the maze and find Purple Portals or the color you chose. Walk into them to start a Chess Battle.
5. Strategize: Defeat at least 2 Minions to unlock the Boss Portal.
...
6. Super Mode: If you defeat more than the minimum number of dragons (2), you will receive extra Queens to help you against the King Dragon!
7. Win: Checkmate the King Dragon to achieve total victory.

Note: Due to the complexity of the chess and AI initialization, there may be a brief felay when each chess battle begins.
