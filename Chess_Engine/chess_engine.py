...
from Chess_Engine.piece_points import piece_square_mid_game, piece_square_end_game, PHASE_WEIGHTS
...
class Chess:
    ...
    def make_move(self, move):
        ...
        self.end_game_score -= piece_square_end_game[piece][start]
